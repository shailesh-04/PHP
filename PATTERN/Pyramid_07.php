    ...
    <div class="container bg-dark p-3 mt-4 text-light border border-4 border-secondry rounded">
      <div class="row p-3 ">
        <div class="col-12 border-bottom border-4 text-warning">
          <h2>PYRAMID : 7  String Pattern Print Charcter</h2>
        </div>
      </div>
      <div class="row p-3">
        <div class="boxInpt col-12">
      <label for="inptString" onmouseout="Valid()">Enter Any String For Pattern Char. . .</label>
      <input type="text" name="inptString" onkeyup="Valid()" id="inptString" class="form-control" required/>
    </div>
      </div>
      <div class="row p-3">
        <div class="col-12">
